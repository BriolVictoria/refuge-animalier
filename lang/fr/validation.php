...
return [
    ...
    | la classe de validation. Certaines règles ont plusieurs versions,
    | comme les règles de taille. N'hésitez pas à adapter chaque message ici.
    |
    */
    ...
    'ascii' => 'Le champ :attribute ne peut contenir que des caractères alphanumériques sur un octet et des symboles.',
    ...
    | des attributs en utilisant la convention "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes permettent de remplacer le placeholder de l’attribut
    | par quelque chose de plus lisible comme "Adresse e-mail" au lieu de "email".
    |
    */
