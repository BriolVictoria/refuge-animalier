...
@foreach($animals as $animal)
    ...
    <tr class="odd:bg-blue-50 even:bg-white border border-blue-100 text-center">
        ...
        <td class="px-4 py-4 hover:underline hover:font-medium"><a href="{!! route('animals.show', $animal->id) !!}">{!! $animal->name !!}</a></td>

        <td class="px-4 py-4">{!! $animal->breed !!}</td>
        <td class="px-4 py-4"><span class="bg-orange-300 py-1 px-2 rounded-2xl">{!! $animal->state !!}</span></td>
