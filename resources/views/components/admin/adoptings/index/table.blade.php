                ...
                <div
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex flex-col items-baseline">
                            ...
                            <a title="{{ __('admin/adoptings.actions.view', ['name' => $adopting->first_name]) }}" href="{!! route('adoptings.show', ['locale' => app()->getLocale(), 'id' => $adopting->id]) !!}"><dd class="text-xs font-light transition-all duration-300 hover:text-blue-800 ">{!! $adopting->last_name !!}</dd></a>
                        </div>

                        <div class="flex flex-col items-baseline">
                            <dt class="text-sm font-medium pr-2.5">{{__('admin/adoptings.fields.first_name')}}</dt>
                            <a title="{{ __('admin/adoptings.actions.view', ['name' => $adopting->first_name]) }}" href="{!! route('adoptings.show', ['locale' => app()->getLocale(), 'id' => $adopting->id]) !!}"><dd class="text-xs font-light transition-all duration-300 hover:text-blue-800 ">{!! $adopting->first_name !!}</dd></a>
                        </div>

                        <div class="flex flex-col items-baseline">
                            <dt class="text-sm font-medium pr-2.5">{{__('admin/adoptings.fields.animal_name')}}</dt>
                            <a title="{{ __('admin/adoptings.actions.view', ['name' => $adopting->animal->first_name]) }}" href="{!! route('animals.show', ['locale' => app()->getLocale(), 'id' => $adopting->id]) !!}"><dd class="text-xs font-light transition-all duration-300 hover:text-blue-800 ">{!! $adopting->animal->name !!}</dd></a>
                        </div>
                    ...
                    <div class="flex mt-7">
                        <a title="{{ __('admin/adoptings.actions.view', ['name' => $adopting->first_name]) }}" href="{!! route('adoptings.show', ['locale' => app()->getLocale(), 'id' => $adopting->id]) !!}" class="inline-block pr-2 transition-all duration-300 hover:scale-105">
                        ...
                        <a title="{{ __('admin/adoptings.actions.edit', ['name' => $adopting->first_name]) }}" href="{!! route('adoptings.edit', ['locale' => app()->getLocale(), 'id' => $adopting->id]) !!}" class="inline-block pr-2 transition-all duration-300 hover:scale-105">
