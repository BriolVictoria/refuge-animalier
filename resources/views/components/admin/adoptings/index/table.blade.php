                ...
                <div
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex flex-col items-baseline">
                            ...
                            <a title="Voir la demande de {!! $adopting->first_name !!}" href="#"><dd class="text-xs font-light transition-all duration-300 hover:text-blue-800 ">{!! $adopting->last_name !!}</dd></a>
                        </div>

                        <div class="flex flex-col items-baseline">
                            <dt class="text-sm font-medium pr-2.5">Prénom de l'adoptant&nbsp;:</dt>
                            <a title="Voir la demande de {!! $adopting->first_name !!}" href="#"><dd class="text-xs font-light transition-all duration-300 hover:text-blue-800 ">{!! $adopting->first_name !!}</dd></a>
                        </div>
