                ...
                <div
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-baseline">
                            <dt class="text-sm font-medium pr-2.5">{{ __('admin/volunteers.fields.last_name')}}&nbsp;:</dt>
                            <a title="{{ __('admin/volunteers.buttons.view', ['name' => $volunteer->first_name])}}" href="{!! route('volunteers.show', ['locale' => app()->getLocale(), 'id' => $volunteer->id]) !!}"><dd class="text-xs font-light transition-all duration-300 hover:text-blue-800 ">{!! $volunteer->last_name !!}</dd></a>

                        </div>

                        <div class="flex items-baseline">
                            <dt class="text-sm font-medium pr-2.5">{{ __('admin/volunteers.fields.first_name')}}&nbsp;:</dt>
                            <a title="{{ __('admin/volunteers.buttons.view', ['name' => $volunteer->first_name])}}" href="{!! route('volunteers.show', ['locale' => app()->getLocale(), 'id' => $volunteer->id]) !!}"><dd class="text-xs font-light transition-all duration-300 hover:text-blue-800 ">{!! $volunteer->first_name !!}</dd></a>

                        </div>

                        <div class="flex items-baseline">
                            <dt class="text-sm font-medium pr-2.5">{{ __('admin/volunteers.fields.email')}}&nbsp;:</dt>
                            <dd class="text-xs font-light">{!! $volunteer->email !!}</dd>
                        </div>

                        <div class="flex items-baseline">
                            <dt class="text-sm font-medium pr-2.5">{{ __('admin/volunteers.fields.phone_number')}}&nbsp;:</dt>
                            <dd class="text-xs font-light">{!! $volunteer->phone_number !!}</dd>
                        </div>


                    </div>
                    <div class="flex mt-7">
                        <a title="{{ __('admin/volunteers.buttons.view', ['name' => $volunteer->first_name])}}" href="{!! route('volunteers.show', ['locale' => app()->getLocale(), 'id' => $volunteer->id]) !!}" class="inline-block pr-2 transition-all duration-300 hover:scale-105">
                        ...
                        <a title="{{ __('admin/volunteers.buttons.edit', ['name' => $volunteer->first_name])}}" href="{!! route('volunteers.edit', ['locale' => app()->getLocale(), 'id' => $volunteer->id]) !!}" class="inline-block pr-2 transition-all duration-300 hover:scale-105">
