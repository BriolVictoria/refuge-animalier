@forelse($this->volunteers as $volunteer)
    ...
    <tr class="odd:bg-blue-50 even:bg-white border border-blue-100 text-center">
        <td class="px-4 py-4 transition-all duration-300 hover:text-blue-800"><a title="{{ __('admin/volunteers.buttons.view', ['name' => $volunteer->first_name])}}" href="{!! route('volunteers.show', ['locale' => app()->getLocale(), 'id' => $volunteer->id]) !!}">{!! $volunteer->last_name !!}</a></td>
        <td class="px-4 py-4 transition-all duration-300 hover:text-blue-800 "><a title="{{ __('admin/volunteers.buttons.view', ['name' => $volunteer->first_name])}}" href="{!! route('volunteers.show', ['locale' => app()->getLocale(), 'id' => $volunteer->id]) !!}">{!! $volunteer->first_name !!}</a></td>
        ...
        <td class="px-4 py-4">
            ...
            <a title="{{ __('admin/volunteers.buttons.edit', ['name' => $volunteer->first_name])}}" href="{!! route('volunteers.edit', ['locale' => app()->getLocale(), 'id' => $volunteer->id]) !!}" class="inline-block pr-2transition-all duration-300 hover:scale-105">
                <svg width="28" height="28" viewBox="0 0 28 28"
                    ...
                    <path
                        ...
                        stroke="#26486C" stroke-width="1.45833"  fill="none" stroke-linecap="round"
