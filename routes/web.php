...
Route::prefix('{locale}')->middleware(\App\Http\Middleware\SetLocaleMiddleware::class)->group(function (){
    ...
    Route::get('/contact', [ContactController::class, 'index'])->name('public.contactpage');
    ...
    Route::post('/animals', [\App\Http\Controllers\AnimalController::class, 'store'])->name('public.animal.store');
